                ...
                if(data.status == 'success') {
                    ...
                    if(data.data) {
                        ...
                        for(var i in e) {
                            ...
                            <td>${e[i].metadata.teachers?.join(', ') || '<i class="w-small w-text-gray">No teacher assigned</i>'}</td>
                            <td>${e[i].metadata.classes?.join(', ') || '<i class="w-small w-text-gray">No classes added</i>'}</td>
                            <td class="w-text-gray h4">
